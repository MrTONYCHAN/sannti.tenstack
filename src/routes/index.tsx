      ...
      <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground">
        ...
        >
          <img
            ...
            width={720}
            height={720}
            className="w-[min(92vw,42rem)] max-w-none opacity-[0.08] mix-blend-multiply dark:opacity-[0.05] dark:mix-blend-screen"
          />
        </div>
          ...
          <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
            <div className="flex items-center gap-2">
              <img
                src={logo}
                alt="Saanti logo"
                className="h-9 w-9 mix-blend-multiply dark:mix-blend-screen"
                width={36}
                height={36}
              />
